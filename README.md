...
- The file `hw01_iris.md` contains an R Markdown document that explores the iris data frame in R. You can see the data by typing the folowig line on your R console:
```R
iris
```
